...
class Users(base):
    ...
    '''
    these are the rows to be created inside the users table
    the privacy part represents:
    - False if not agreed, True if agreed
    - GDPR privacy follows the same reasoning but is divided
    in two levels, marketing and necessary
    '''
...
# creating DB and table that resembles the class just created,
